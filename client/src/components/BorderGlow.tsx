/**
 * BorderGlow — third-party React Bits component.
 *
 * Renders a card with a directional mesh-gradient border + outer glow
 * that activates when the cursor approaches the edges. Glow direction
 * follows the cursor's angle relative to the card center.
 *
 * Used to wrap unsolved QuestionCards in the challenge grid.
 */
